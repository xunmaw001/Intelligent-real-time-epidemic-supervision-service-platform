			...
			<div class="data-add-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #5D7599","margin":"30px auto","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"0","borderStyle":"solid"}'>
				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="jiezhongyimiao" id="jiezhongyimiao" lay-filter="jiezhongyimiao"  >
		                        <option value="">请选择</option>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(132, 132, 132, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text" name="jiezhongshijian" id="jiezhongshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="hesuanjiance" id="hesuanjiance" lay-filter="hesuanjiance"  >
		                        <option value="">请选择</option>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(132, 132, 132, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text" name="jianceshijian" id="jianceshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="jiancejieguo" id="jiancejieguo" lay-filter="jiancejieguo"  >
		                        <option value="">请选择</option>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="fengxiandiqu" id="fengxiandiqu" lay-filter="fengxiandiqu"  >
		                        <option value="">请选择</option>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="shentizhuangtai" id="shentizhuangtai" lay-filter="shentizhuangtai"  >
		                        <option value="">请选择</option>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(132, 132, 132, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text" name="dengjiriqi" id="dengjiriqi" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(132, 132, 132, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.xinxiyuanzhanghao" type="text" :readonly="ro.xinxiyuanzhanghao" name="xinxiyuanzhanghao" id="xinxiyuanzhanghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}' class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
				...
				data: {
					...
					yonghuzhanghao: [],
					jiezhongyimiao: '是,否'.split(','),
					hesuanjiance: '是,否'.split(','),
					jiancejieguo: '阴性,阳性'.split(','),
					fengxiandiqu: '低分险,高中风险'.split(','),
					shentizhuangtai: '良好,不适'.split(','),
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(jiezhongyimiao)', function (data) {
                    vue.detail.jiezhongyimiao=data.value;
                });
                                jquery('#jiezhongshijian').val(getCurDate());
				laydate.render({
					elem: '#jiezhongshijian'
				});
                form.on('select(hesuanjiance)', function (data) {
                    vue.detail.hesuanjiance=data.value;
                });
                                jquery('#jianceshijian').val(getCurDate());
				laydate.render({
					elem: '#jianceshijian'
				});
                form.on('select(jiancejieguo)', function (data) {
                    vue.detail.jiancejieguo=data.value;
                });
                form.on('select(fengxiandiqu)', function (data) {
                    vue.detail.fengxiandiqu=data.value;
                });
                form.on('select(shentizhuangtai)', function (data) {
                    vue.detail.shentizhuangtai=data.value;
                });
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					data = data.data
					for(var key in data){
                        if(key=='xinxiyuanzhanghao'){
                                vue.detail['xinxiyuanzhanghao'] = data[`${key}`]
                                vue.ro.xinxiyuanzhanghao = true;
                                continue;
                        }
                        if(key=='xinxiyuanxingming'){
                                vue.detail['xinxiyuanxingming'] = data[`${key}`]
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='jiezhongshijian'){
                                                ...
                                                jquery('#jiezhongshijian').val(obj[o]);
                                                continue;
                                        }
                                        ...
                                        if(o=='jianceshijian'){
                                                ...
                                                jquery('#jianceshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='jiancejieguo'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('jiankangxinxicaiji/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('jiankangxinxicaiji' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
