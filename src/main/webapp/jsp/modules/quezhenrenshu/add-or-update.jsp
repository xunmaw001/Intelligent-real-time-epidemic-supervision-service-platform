		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑确诊人数</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑确诊人数</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">确诊人数信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="leibieSelect" name="leibie" class="form-control">
												<option value=""></option>
												<option class="leibieOption" value="有症状">
													有症状
												</option>
												<option class="leibieOption" value="无症状">
													无症状
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>确诊人数</label>
										<input name="quezhenrenshu" id="quezhenrenshu" name="quezhenrenshu" class="form-control" placeholder="确诊人数">
									</div>
									<div class="form-group col-md-6">
										<label>登记时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "quezhenrenshu/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("quezhenrenshu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("quezhenrenshu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("quezhenrenshu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("quezhenrenshu"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#quezhenrenshu").val(ruleForm.quezhenrenshu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.quezhenrenshu != null && res.data.quezhenrenshu != ''){

						$("#quezhenrenshu").val(res.data.quezhenrenshu);
						$("#quezhenrenshu").attr('readonly','readonly');
					}
