...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑问题上报</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑问题上报</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">问题上报信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>上报编号</label>
										<input id="shangbaobianhao" name="shangbaobianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>上报人数</label>
									...
									<div class="form-group col-md-6">
										<label>上报时间</label>
										<div id="shangbaoshijianDate" class="input-append date form_datetime">
											<input id="shangbaoshijian-input" name="shangbaoshijian" size="15" type="text" readonly>
	...
	<script>
		...
		function shangbaobianhaoUuid(){
			if($("#shangbaobianhao").val() == null || $("#shangbaobianhao").val() == "null" || $("#shangbaobianhao").val() == ""){
				$("#shangbaobianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "wentishangbao/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("wentishangbao/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("wentishangbao/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#shangbaoshijian-input").val(getCurDate());
			$("#shangbaoshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#shangbaobianhao").val(ruleForm.shangbaobianhao);	
			$("#shangbaorenshu").val(ruleForm.shangbaorenshu);	
			$("#zhengzhuangmiaoshu").val(ruleForm.zhengzhuangmiaoshu);
			$("#shangbaoshijian-input").val(ruleForm.shangbaoshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shangbaobianhao != null && res.data.shangbaobianhao != ''){

						$("#shangbaobianhao").val(res.data.shangbaobianhao);
						$("#shangbaobianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.shangbaoshijian != null && res.data.shangbaoshijian != ''){

						$("#shangbaoshijian-input").val(res.data.shangbaoshijian);
						$('#shangbaoshijianFileName').val(res.data.shangbaoshijian)
					}
