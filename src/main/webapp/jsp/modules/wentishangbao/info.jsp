						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shangbaobianhao" name="shangbaobianhao" class="form-control" v-model="ruleForm.shangbaobianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>上报人数</label>
									...
									<input id="shangbaoshijian" name="shangbaoshijian" class="form-control" v-model="ruleForm.shangbaoshijian" readonly>
									</div>
