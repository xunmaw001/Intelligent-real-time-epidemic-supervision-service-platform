...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑菜单</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">菜单信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>菜单</label>
										<textarea  name="menujson" class="form-control" id="menujson" rows="3"></textarea>
									</div>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("menu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("menu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#menujson").val(ruleForm.menujson);
		}		
		//图片显示
		function showImg(){
		}		
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.menujson != null && res.data.menujson != ''){

						$("#menujson").val(res.data.menujson);
					}
				}
			});  
            }
