						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="diaodubianhao" name="diaodubianhao" class="form-control" v-model="ruleForm.diaodubianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>信息员账号</label>
									...
									<input id="xinxiyuandianhua" name="xinxiyuandianhua" class="form-control" v-model="ruleForm.xinxiyuandianhua" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>发布时间</label>
									...
									<input id="renwubiaoti" name="renwubiaoti" class="form-control" v-model="ruleForm.renwubiaoti" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>封面</label>
									...
									<div class="form-group  col-md-12">
										<label>任务内容</label>
										<script id="renwuneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.renwuneirong != null && ruleForm.renwuneirong != 'null' && ruleForm.renwuneirong != ''){
				var mes = '' + ruleForm.renwuneirong;
				var renwuneirongUeditor = UE.getEditor('renwuneirongEditor');
				renwuneirongUeditor.ready(function() {
					renwuneirongUeditor.setContent(mes);
					renwuneirongUeditor.setDisabled('fullscreen');
				});
			}
		}  
