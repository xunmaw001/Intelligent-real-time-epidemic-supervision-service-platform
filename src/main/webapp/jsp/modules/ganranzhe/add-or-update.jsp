					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑感染者</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">感染者信息</h3>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<select id="leixingSelect" name="leixing" class="form-control">
												<option value=""></option>
												<option class="leixingOption" value="有症状">
													有症状
												</option>
												<option class="leixingOption" value="无症状">
													无症状
												</option>
										</select>	
									</div>	
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("ganranzhe/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("ganranzhe/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("ganranzhe/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
