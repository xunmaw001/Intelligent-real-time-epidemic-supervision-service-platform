	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">信息员账号</label> 
							<input  name="xinxiyuanzhanghao" placeholder="信息员账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">信息员姓名</label> 
							<input  name="xinxiyuanxingming" placeholder="信息员姓名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">信息员电话</label> 
							<input  name="xinxiyuandianhua" placeholder="信息员电话" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "xinxiyuan/register";
				$.ajax({ 
					type: "POST",
					url: url,
