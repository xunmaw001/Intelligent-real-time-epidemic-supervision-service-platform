					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑信息员</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">信息员信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>信息员账号</label>
										<input name="xinxiyuanzhanghao" readonly id="xinxiyuanzhanghao" name="xinxiyuanzhanghao" class="form-control" placeholder="信息员账号">
									</div>
									<div class="form-group col-md-6">
										<label>信息员姓名</label>
									...
									<div class="form-group col-md-6">
										<label>信息员电话</label>
										<input name="xinxiyuandianhua"  id="xinxiyuandianhua" name="xinxiyuandianhua" class="form-control" placeholder="信息员电话">
									</div>
									<div class="form-group col-md-6">
										<label>头像</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("xinxiyuan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xinxiyuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
