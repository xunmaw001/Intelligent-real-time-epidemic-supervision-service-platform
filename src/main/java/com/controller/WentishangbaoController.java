...
public class WentishangbaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,WentishangbaoEntity wentishangbao, 
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xinxiyuan")) {
			wentishangbao.setXinxiyuanzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WentishangbaoEntity wentishangbao, 
		HttpServletRequest request){
        EntityWrapper<WentishangbaoEntity> ew = new EntityWrapper<WentishangbaoEntity>();
    	PageUtils page = wentishangbaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, wentishangbao), params), params));
		request.setAttribute("data", page);
